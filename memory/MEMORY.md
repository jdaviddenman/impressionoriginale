...
- [Termly preconnect + async fix](termly-preconnect-async-fix.md) — Termly resource-blocker (4,350ms render-blocking) optimized with preconnect + async via mu-plugin. Consent gated by Consent Mode v2 denied defaults. Deployed 2026-07-19.
